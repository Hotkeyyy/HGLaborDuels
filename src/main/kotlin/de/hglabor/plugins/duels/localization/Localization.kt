...
object Localization {
    ...
    val YOU_DUELED_EN = "${PREFIX}You challenged ${KColors.DODGERBLUE}%playerName% ${KColors.GRAY}with the kit ${KColors.MEDIUMPURPLE}%kit%${KColors.GRAY}."
    val YOU_DUELED_DE = "${PREFIX}Du hast ${KColors.DODGERBLUE}%playerName% ${KColors.GRAY}mit dem Kit ${KColors.MEDIUMPURPLE}%kit% ${KColors.GRAY}herrausgefordert."
    val YOU_WERE_DUELED_EN = "${PREFIX}${KColors.DODGERBLUE}%playerName% ${KColors.GRAY}challenged you with the kit ${KColors.MEDIUMPURPLE}%kit%${KColors.GRAY}."
    val YOU_WERE_DUELED_DE = "${PREFIX}Du wurdest von ${KColors.DODGERBLUE}%playerName% ${KColors.GRAY}mit dem Kit ${KColors.MEDIUMPURPLE}%kit% ${KColors.GRAY}herrausgefordert."
